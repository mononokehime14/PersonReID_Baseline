...
def test_cross_dataset(config_file,test_dataset, **kwargs):
    ...
    # Person_ReID_Dataset_Downloader('/home/GTA',test_dataset)    
    _, val_loader, num_query, _ = data_loader(cfg, test_dataset, is_train=False)
    
    re_ranking=cfg.RE_RANKING
    
    if 'NTUOutdoor_Color' in test_dataset:
