...
def Person_ReID_Dataset_Downloader(save_dir, dataset_name):
    ...
    if not os.path.exists(save_dir_exist) and  (dataset_name in dataset_list):
        ...
        url = "https://linshan-datasets.s3-ap-southeast-1.amazonaws.com/Person_ReID/{}.zip".format(dataset_name)
